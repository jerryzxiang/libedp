# -*- coding: utf-8 -*-
"""
Created on Sun Nov  7 23:13:19 2021
...
parser.add_argument('cathode', type=str, help='type of cathode (LCO, LNO, UG811, LFP')
...
elif args.cathode == "LNO":
    folder_filepath = 'Box\\PNE - R&D (Xiaofang)\\R&D Adminstration\\Projects\\High Ni\\Experimental Data\\E-chem\\'
    results_filepath = user_filepath + folder_filepath + 'Results\\'    
    excelsheets_filepath = user_filepath + folder_filepath + 'NDA and Excel files\\Excel\\'
    df = pd.ExcelFile(user_filepath + folder_filepath + 
                      'PNE High Ni Echem data summary.xlsx').parse('Performance Summary')
    
elif args.cathode == "UG811":
    folder_filepath = 'Box\\PNE - R&D (Xiaofang)\\R&D Adminstration\\Projects\\Upcycling NCM523 to NCM811\\Experimental Data\\E-chem\\'
    results_filepath = user_filepath + folder_filepath + 'Results\\'    
    df = pd.ExcelFile(user_filepath + folder_filepath + 'UG-NCM811_Echem_Data.xlsx').parse('Performance Summary')
